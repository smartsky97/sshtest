 ...
 * 
 * @see com.zjt.entity.Newstype
 * @author MyEclipse Persistence Tools
 */
public class NewstypeDAO extends HibernateDaoSupport {
	private static final Log log = LogFactory.getLog(NewstypeDAO.class);
	// property constants
	...
	public Newstype findById(java.lang.Integer id) {
		...
		try {
			Newstype instance = (Newstype) getHibernateTemplate().get(
					"com.zjt.entity.Newstype", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public Newstype merge(Newstype detachedInstance) {
		...
		try {
			Newstype result = (Newstype) getHibernateTemplate().merge(
					detachedInstance);
	...
	public static NewstypeDAO getFromApplicationContext(ApplicationContext ctx) {
		return (NewstypeDAO) ctx.getBean("NewstypeDAO");
	}
}